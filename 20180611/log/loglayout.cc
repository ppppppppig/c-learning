...
{
	log4cpp::OstreamAppender* osAppender = new log4cpp::OstreamAppender("osAppender", &cout);//创建一个Appender，指定输出的目的地

	log4cpp::PatternLayout* pLayout = new log4cpp::PatternLayout();//设置layout
